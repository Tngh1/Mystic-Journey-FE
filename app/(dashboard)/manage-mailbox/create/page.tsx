      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Compose and deliver mail to players</p>
          </div>
        </div>
        <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#1a1a1a] border border-gray-800">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 items-start">
            ...
            <div className="flex items-center gap-2">
              {activeStep > 1 && (
                <button
                  ...
                  className="px-5 py-2.5 bg-[#1a1a1a] hover:bg-[#222] text-gray-400 hover:text-white border border-gray-700 hover:border-gray-600 rounded-xl font-medium transition-all disabled:opacity-50"
                >
                  Back
                </button>
              )}
        ...
        <div className="space-y-3 lg:sticky lg:top-6">
          ...
          <button
            type="button"
            onClick={() => router.push("/manage-mailbox")}
            className="w-full px-4 py-2.5 text-sm text-gray-500 hover:text-gray-300 transition-colors"
          >
            ← Back to Mailbox
          </button>
        </div>
