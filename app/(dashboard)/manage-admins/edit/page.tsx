  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Edit Admin Account</h1>
          <p className="text-white/50 text-sm">Update admin details (ID: {adminId})</p>
        </div>
      </div>
