...
import { Save, BookOpen, Target, Shield, Gift } from "lucide-react";
...
export default function CreateQuestPage() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 pb-32">
      <FormHeader
        title="Create Quest"
        subtitle="Add a new quest to the game"
      ...
      <FormSection title="General Information" icon={BookOpen}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <FormField label="Quest Giver" htmlFor="questGiverName" hint="NPC name">
            <TextInput
              id="questGiverName"
      ...
      <FormSection title="Objectives & Location" icon={Target} iconColor="text-red-400">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <FormField label="Objective Target" htmlFor="objectiveTarget" hint="Boss/NPC/Chest">
            <TextInput
              id="objectiveTarget"
      ...
      <FormSection title="Rewards" icon={Gift} iconColor="text-green-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <FormField label="Reward Skill ID" htmlFor="rewardSkillId" hint="Optional">
            <TextInput
              id="rewardSkillId"
              type="number"
